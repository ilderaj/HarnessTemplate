...
| Where am I going? | Commit the feature branch, merge into local `dev`, resolve any conflicts, and push |
...
| What have I done? | Implemented renderer + hook + CLI surfaces, updated docs, passed repo-wide verification, and prepared the task for integration |
